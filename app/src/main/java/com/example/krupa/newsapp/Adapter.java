...
public class Adapter extends ArrayAdapter<NewsArticleData> {
    private static final String LOG_TAG = Adapter.class.getSimpleName();

    // Get article list
    Adapter(Context context, List<NewsArticleData> articleList) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        // Get current article
        NewsArticleData currentArticle = getItem(position);
    ...
    private Bitmap formatImageFromBitmap(Bitmap articleThumbnail) {
        ...
        if (articleThumbnail == null) {
            ...
            returnBitmap = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.no_image);
        } else {
