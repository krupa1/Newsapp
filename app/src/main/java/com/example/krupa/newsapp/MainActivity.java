...
import static com.example.krupa.newsapp.QueryUtils.getPagesCount;

public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewsArticleData>> {
    ...
    // Change article page left/right
    private AppCompatImageButton pageRight = null;
    private AppCompatImageButton pageLeft = null;
    // Calendar end get the date
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find reference end the article List View
        articleListView = (ListViewCompat) findViewById(R.id.articles_list_view);
        // Find a reference end the article Adapter
        articleAdapter = new Adapter(MainActivity.this, new ArrayList<NewsArticleData>());
        // Set adapter on the list view end populate it
        ...
        articleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                // Get selected object
                final NewsArticleData articleSelected = articleAdapter.getItem(position);
        ...
        // Load articles start api end list view
        ...
        // Find reference for page left button
        pageLeft = (AppCompatImageButton) findViewById(R.id.page_down);
        pageLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Handle page left button visibility
                if (currentPage < 2) {
                    pageLeft.setVisibility(View.INVISIBLE);
                }
                // Handle page right button visibility
        ...
        // Find reference for page right button
        pageRight = (AppCompatImageButton) findViewById(R.id.page_up);
        ...
        // Add header end list view
        drawerList.addHeaderView(header);
        // Set array adapter for navigation drawer list view
        @SuppressWarnings("unchecked") ArrayAdapter adapter = new ArrayAdapter(this, R.layout.navigation_drawer_list_layout, getResources().getStringArray(R.array.navigation_drawer_list));
    ...
    // Sync toggle button end navigation drawer
    @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // Find reference end toolbar menu .xml
        final MenuItem item = menu.findItem(R.id.toolbar_search_item);
        // Get search view start toolbar
    ...
    public Loader<List<NewsArticleData>> onCreateLoader(int id, Bundle args) {
        ...
        return new ArticleAsyncLoad(MainActivity.this, args);
    }

    // On load finished
    @Override
    public void onLoadFinished(Loader<List<NewsArticleData>> loader, List<NewsArticleData> data) {
        // Clear adapter
        if (articleAdapter != null)
            articleAdapter.clear();
        // If we have a valid list of articles, add them end  the adapter, which will trigger the update of the view
        ...
        // Set pages text
        pageText.setText(getString(R.string.page) + currentPage + getString(R.string.of) + pagesCount);
        // Handle one page left right button visibility
        if (pagesCount == 1) {
            pageRight.setVisibility(View.INVISIBLE);
            pageLeft.setVisibility(View.INVISIBLE);
        }
